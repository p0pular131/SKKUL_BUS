...
# 모델 검증 실행
python3 leaderboard_evaluator_local.py --agent-config /home/heven/SKKUL_BUS/pretrained_models/all_towns --agent /home/heven/SKKUL_BUS/team_code/sensor_agent_skku.py --routes /home/heven/SKKUL_BUS/leaderboard/data/debug.xml --checkpoint $SAVE_PATH/result.json
